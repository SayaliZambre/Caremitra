...
export default function Page({ params }) {
  ...
  const addPatientandHealthProfile = async () => {
    try {
      const response = await axios.post("https://a3c5-14-139-109-130.ngrok-free.app/patient/add", {
        firstName: firstName,
        lastName: lastName,
        userId: Id,
      ...
      try {
        const response = await axios.post(
          " https://e007-152-59-6-114.ngrok-free.app/patient/addhealthprofile/" + patientId,
          {
            address: address,
            dob: dob,
            height: height,
